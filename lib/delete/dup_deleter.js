 ...
 *
 * The above process is repeated for size number of values every time, till no duplicates are left
 *
 ...
 * @param size the batch size of unique key values to dedup every time. Default value is 1000. Value to the tune of 10000 slows down a lot.
...
if(require.main === module){
  module.exports({key:"url",size:1000,del_sort:{fetch_time:"desc"},index:"test",type:"test",multi_key:"url"}).
  then(function(res){
    console.log(res)
  })
}
