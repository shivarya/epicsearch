 ...
 *@param queryField The field on which to do term query to get first document matching it
 *@param val The value to match for given queryField
 *@param sort How to sort the duplicates for queryField:  val
...
GetFirst.prototype.chew = function(params) {
  ...
  var instructions =
    ...
    .map(function(val) {
      ...
      match_pair[params.queryField] = val
...
if (require.main === module) {
  ...
  es.get_first({
    index:  'test', type:  'test', queryField:  'url',
    val:  ['12'], sort: {fetch_time: 'asc'}, fields: ['fetch_time']
  }).then(function(res) {
