...
if (require.main === module) {
  ...
  es.bulk.collect({body: [{delete: {_type: 'test2', _index: 'test2', _id: '1'}}]})
  .then(function(res) {debug(JSON.stringify(res)); return true})
  .catch(debug)

  es.bulk.collect({body: [{index: {_id: 'Wase5HP7Tb6WlLzNSSbvzA'}},{url: 14},{index: {_index: 'test2', _type: 'test2', _id: 1}},{url: 12}], index: 'test1', type: 'test1'})
  .then(function(res) {debug(JSON.stringify(res)); return true})
  .catch(debug)
